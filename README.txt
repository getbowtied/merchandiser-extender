...
= 1.4.0 =
- Fixed: Product category header display issue
...
= 1.3.4 =
- WooCommerce 3.7 compatibility updates
...
- Adds: Theme-specific WPBakery Page Builder elements: Slider, Banner, Blog Posts, Title, Social Media profiles (functionality transferred from the theme).
