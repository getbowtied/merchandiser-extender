 ...
 *
 * @package MC_Ext_Customizer_Repeater_Control
 */
...
/**
 * Class MC_Ext_Customizer_Repeater_Control
 */
class MC_Ext_Customizer_Repeater_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<button type="button" class="button add_field customizer-repeater-new-field">
			<?php esc_html_e( 'Add a Profile', 'merchandiser-extender' ); ?>
		</button>
	...
	private function iterate_array( $array = array() ) {
		...
		if( !empty( $array ) ) {
			foreach( $array as $icon ) {
				...
				<div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
					<div class="customizer-repeater-customize-control-title">
						<?php echo !empty( $icon->title ) ? esc_html( $icon->title ) : esc_html( 'Social Media Profile', 'merchandiser-extender' ); ?>
					</div>
					<div class="customizer-repeater-box-content-hidden">
						...
						$this->input_control( array(
							'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Title:','merchandiser-extender' ), $this->id, 'customizer_repeater_title_control' ),
						...
						$this->input_control( array(
							'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Link:','merchandiser-extender' ), $this->id, 'customizer_repeater_link_control' ),
						...
						<button type="button" class="social-repeater-general-control-remove-field">
							<?php esc_html_e( 'Remove', 'merchandiser-extender' ); ?>
						</button>
						<span>|</span>
						<button type="button" class="social-repeater-general-control-done-field">
							<?php esc_html_e( 'Done', 'merchandiser-extender' ); ?>
						</button>
					</div>
				</div>
				<?php
			...
			<div class="customizer-repeater-general-control-repeater-container">
				<div class="customizer-repeater-customize-control-title">
					<?php esc_html_e( 'Social Media Profile', 'merchandiser-extender' ); ?>
				</div>
				<div class="customizer-repeater-box-content-hidden">
					<?php
	...
	private function icons_control( $value = 'facebook' ) {
		...
		<div class="customizer-repeater-icon-control">
			<span class="customize-control-title">
				<?php esc_html_e('Icon:','merchandiser-extender'); ?>
			</span>
			...
			<form class="customizer-repeater-icons">
				...
				<div>
					...
					<span class="tooltip"><?php esc_html_e( 'Custom Icon', 'merchandiser-extender' ); ?></span>
				</div>
			</form>
		</div>
		<?php
	...
	private function image_control( $value = '', $icon_slug = '' ) {
		...
		<div class="customizer-repeater-image-control" <?php echo ( $icon_slug !== 'custom' ) ? 'style="display:none;"' : ''; ?>>
			<span class="customize-control-title">
				<?php esc_html_e('Image:','merchandiser-extender')?>
			</span>
			...
			<input type="button" class="button button-secondary customizer-repeater-custom-media-button" value="<?php echo !empty($value) ? esc_attr( 'Change Image','merchandiser-extender' ) : esc_attr( 'Add Image','merchandiser-extender' ); ?>" />
		</div>
		<?php
	 ...
	 */
	 public function enqueue() {
		...
		wp_enqueue_style(
			'tr-ext-customizer-repeater-styles',
		...
		wp_enqueue_script(
			'tr-ext-customizer-repeater-script',
