...
*/
class Merchandiser_Nav_Menu_Output extends Walker_Nav_Menu {
    ...
    */
    ...
    public function start_lvl( &$output, $depth = 0, $args = null ) {
        ...
        if( $depth === 0 && ( 'slices' === get_theme_mod( 'header_navigation_style', 'slices' ) ) && isset($args->background_color) && !empty($args->background_color) ) {
