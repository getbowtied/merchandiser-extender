	...
	registerBlockType( 'getbowtied/mc-posts-grid', {
		...
		edit: function( props ) {
			...
			function renderResults() {
				...
				if( posts.length > 0) {
					...
					for ( let i = 0; i < posts.length; i++ ) {
						...
						let img = '';
						let img_class = 'gbt_18_mc_editor_posts_grid_noimg';
						if ( posts[i]['fimg_url'] ) { img = posts[i]['fimg_url']; img_class = 'gbt_18_mc_editor_posts_grid_with_img'; } else { img_class = 'gbt_18_mc_editor_posts_grid_noimg'; img = ''; };

						postElements.push(
							el( "div",
								{
									key: 		'gbt_18_mc_editor_posts_grid_item_' + posts[i].id,
									className: 	'gbt_18_mc_editor_posts_grid_item'
								},
								el( "a",
									{
										key: 		'gbt_18_mc_editor_posts_grid_item_link_' + i,
										className: 	'gbt_18_mc_editor_posts_grid_item_link'
									},
									el( "span",
										{
											key: 		'gbt_18_mc_editor_posts_grid_img_container_' + i,
											className: 	'gbt_18_mc_editor_posts_grid_img_container'
										},
										el( "span",
											{
												key: 'gbt_18_mc_editor_posts_grid_img_overlay_' + i,
												className: 'gbt_18_mc_editor_posts_grid_img_overlay'
											}
										),
										el( "span",
											{
												key: 		'gbt_18_mc_editor_posts_grid_img_' + i,
												className: 	'gbt_18_mc_editor_posts_grid_img ' + img_class,
									...
									el( "span",
										{
											key: 		'gbt_18_mc_editor_posts_grid_title_' + i,
											className:  'gbt_18_mc_editor_posts_grid_title',
			...
			return [
				...
				el( 'div',
					{
						key: 		'gbt_18_mc_posts_grid',
						className: 	'gbt_18_mc_posts_grid'
					},
					el(
						'div',
						{
							key: 		'gbt_18_mc_editor_posts_grid_wrapper',
							className: 	'gbt_18_mc_editor_posts_grid_wrapper columns-' + attributes.columns,
						},
