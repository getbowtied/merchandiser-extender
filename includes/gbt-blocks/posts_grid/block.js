					...
					for ( let i = 0; i < posts.length; i++ ) {
						...
						postElements.push(
							el( "div", 
								...
								el( "a", 
									{
										key: 		'gbt_18_mc_editor_posts_grid_item_link',
										className: 	'gbt_18_mc_editor_posts_grid_item_link'
									},
									el( "span", 
										{ 
											key: 		'gbt_18_mc_editor_posts_grid_img_container',
											className: 	'gbt_18_mc_editor_posts_grid_img_container'
										},
										el( "span", 
											{
												key: 'gbt_18_mc_editor_posts_grid_img_overlay',
												className: 'gbt_18_mc_editor_posts_grid_img_overlay'
											}
										),
										el( "span", 
											{
												key: 		'gbt_18_mc_editor_posts_grid_img',
									...
									el( "span", 
										{
											key: 		'gbt_18_mc_editor_posts_grid_title',
