			...
			return el( 
				...
				el( 
					'div',
					{
						...
						className: attributes.fullHeight ? 'shortcode_getbowtied_slider gbt_18_mc_slider_container swiper-container full_height' : 'shortcode_getbowtied_slider gbt_18_mc_slider_container swiper-container',
						style:
						{
